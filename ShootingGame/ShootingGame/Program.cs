...
namespace ShootingGame
{
    ...
    public class Player
    {
        ...
        public void BulletDraw()
        {
            ...
            for (int i = 0; i < 20; i++)
            {
                ...
                if (playerBullet[i].fire == true)
                {
                    ...
                    playerBullet[i].x+=2; //미사일 오른쪽으로 날라가기
        ...
        public void BulletDraw2()
        {
            ...
            for (int i = 0; i < 20; i++)
            {
                ...
                if (playerBullet2[i].fire == true)
                {
                    ...
                    playerBullet2[i].x+=4; //미사일 오른쪽으로 날라가기
                    
                        if (playerBullet2[i].y>2)
                        {
                            playerBullet2[i].y--;
                        }
                        else
        ...
        public void BulletDraw3()
        {
            ...
            for (int i = 0; i < 20; i++)
            {
                ...
                if (playerBullet3[i].fire == true)
                {
                    ...
                    playerBullet3[i].x+=4; //미사일 오른쪽으로 날라가기

                    
                        if (playerBullet3[i].y <20)
                        {
                            playerBullet3[i].y++;
                        }
                        else
        ...
        public void ClashEnemyAndBullet(Enemy enemy)
        {
            ...
            for (int i = 0; i < 20; i++)
            {
                ...
                {
                    //미사일과 적의 y값이 같을때 
                    if (playerBullet2[i].y == enemy.enemyY || Math.Abs(playerBullet2[i].y - enemy.enemyY)<=1)
                    {
    ...
    public class Enemy //적 클래스
    {
        ...
        public Enemy(int randX,int randY)
        {
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Enemy enemy = new Enemy(rand.Next(65,72), rand.Next(2, 22)); //적생성
            Enemy enemy2 = new Enemy(rand.Next(65, 72), rand.Next(2, 22));
